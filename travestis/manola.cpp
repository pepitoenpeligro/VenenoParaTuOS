...
int main(){
	...
	cout << "la Manola que vivií entonces también conmigo, me dijo" << endl;
	cout << "veneno, que se te han puesto unos cardenales enormes," << endl;
	cout << "claro, yo llamé a berenjeno de Barcelona, " << endl;
	cout << "un cirjano, mira lo que me pasa" << endl;
	...
	cout << "precisamente, os podeis enterar por Descorporacion Dermoesttica" << endl;
