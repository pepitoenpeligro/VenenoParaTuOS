...
int main(){
	...
	cout << "Yo nunca en la vida te he visto, yo soy conosida mundiar" << endl;
	cout << "¿Donde eres conocía?, eres conocia de aquí a Vallecah" << endl;
	...
	cout << "no vengo a un plató de television a cri-criticar a la Tamara como tu" << endl;
	...
	cout << "pero tú esa cara de mona de tarzán, ¿a quién te vas a tirar?" << endl;
	return 0;
}
